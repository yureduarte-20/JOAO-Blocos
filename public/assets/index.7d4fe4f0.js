var P=Object.defineProperty,M=Object.defineProperties;var B=Object.getOwnPropertyDescriptors;var O=Object.getOwnPropertySymbols;var U=Object.prototype.hasOwnProperty,V=Object.prototype.propertyIsEnumerable;var L=(e,a,r)=>a in e?P(e,a,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[a]=r,T=(e,a)=>{for(var r in a||(a={}))U.call(a,r)&&L(e,r,a[r]);if(O)for(var r of O(a))V.call(a,r)&&L(e,r,a[r]);return e},$=(e,a)=>M(e,B(a));import{W as We,s as styled,a as api,r as react,j as jsx,b as axios,d as dist,U as Ue,c as jsxs,F as Fragment,u as useLocation,e as useNavigate,L as Link,B as Blockly,P as PtBr,f as BlocklyWorkspace,l as lodash,g as javascript,h as lua,p as python,i as php,k as dart,m as useParams,M as Modal,S as SyntaxHighlighter,n as lib,R as Routes,o as Route,N as Navigate,H as HashRouter,q as ReactDOM}from"./vendor.29e32d76.js";const p=function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const c of document.querySelectorAll('link[rel="modulepreload"]'))d(c);new MutationObserver(c=>{for(const t of c)if(t.type==="childList")for(const x of t.addedNodes)x.tagName==="LINK"&&x.rel==="modulepreload"&&d(x)}).observe(document,{childList:!0,subtree:!0});function r(c){const t={};return c.integrity&&(t.integrity=c.integrity),c.referrerpolicy&&(t.referrerPolicy=c.referrerpolicy),c.crossorigin==="use-credentials"?t.credentials="include":c.crossorigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function d(c){if(c.ep)return;c.ep=!0;const t=r(c);fetch(c.href,t)}};p();var index="",App$1="",colors={primary:"#FFFFFF",primary_background:"#FBFBFB",primary_input_background:"#F1F1F1",secundary:"#004180",accent:"#F5850F",success:"#5CB660",failure:"#D32F2F",textGray:"#737373;"};const Cores=We`
    .white {
        color: #ffffff ;
    }
    .gray {
...
`;var judge="/assets/judge.7626ed5b.svg";const BoxQuestion=({showCode:e,question:a,onButtonRunPressed:r,onGoForward:d,wrapperStyle:c,test:t,isSubmitting:x,onDetailsClick:u,handleCreateNewDoubt:n})=>jsxs(QuestionWraper,{style:c||{},children:[jsx(ImgWrapper,{children:jsx("img",{src:judge})}),jsxs(Question,{children:[jsx("h2",{children:jsx("strong",{children:a.title})}),jsx("a",{style:{display:"block",cursor:"pointer"},className:"font-1-md orange",onClick:m=>u&&u(),children:"Detalhes"}),jsxs("p",{children:["Voc\xEA pode solicitar ajuda com um orientador",jsx("a",{className:"blue",onClick:m=>n&&n(),style:{cursor:"pointer"},children:" clicando aqui"})]})]}),jsxs(ButtonWrapper,{children:[r&&!x&&jsx(ButtonPrimary,{onClick:r,children:"Enviar!"}),x&&jsx(ButtonPrimary,{style:{display:"flex",justifyContent:"center"},children:jsx(Spinner,{})}),d&&jsx(ButtonSecondary,{onClick:d,children:"Vai pra frente"}),t&&jsx(ButtonSecondary,{onClick:t,children:"Testar"})]}),e&&jsx(ButtonSecondary,{onClick:e,children:"Mostrar c\xF3digo"})]});var Button=styled.button`
    border: none;
    border-radius: 4px;
    padding: ${e=>e.padding?e.padding:"10px 20px"};
...
`,Input=styled.input`
    ...
    border-radius: 4px;
    background-color: #ffff;
`,Signup=()=>{const{setToken:e}=useAuth(),[a,r]=react.exports.useState(!1),d=useApi();useLocation();const c=useNavigate();return jsx(Container$1,{children:jsxs(Wrapper,{children:[jsx("h2",{className:"font-1-xl font-light blue",children:"Cadastra-se"}),jsxs(Form$4,{onSubmit:async x=>{x.preventDefault();let u=x.target[0].value,n=x.target[1].value,m=x.target[2].value,o=x.target[3].value;if(m!=o)return dist.exports.Store.addNotification({container:"top-center",insert:"top",title:"Aten\xE7\xE3o",type:"warning",message:"A senhas n\xE3o coincidem.",dismiss:{duration:3e3,onScreen:!0}});r(!0);try{let l=await d.post("/signup",{email:n,password:m,name:u});e(l.data.token),r(!1),dist.exports.Store.addNotification({container:"top-center",insert:"top",title:"Ok",type:"success",message:"Sua conta foi criada com sucesso!",dismiss:{duration:3e3,onScreen:!0},animationIn:["animate__animated","animate__fadeIn"],animationOut:["animate__animated","animate__fadeOut"]}),c("/",{})}catch(l){console.log(l),console.log(l.response),l.response.status&&dist.exports.Store.addNotification({container:"top-center",insert:"top",title:"Erro",type:"danger",message:l.response.data.error.message,dismiss:{duration:3e3,onScreen:!0},animationIn:["animate__animated","animate__fadeIn"],animationOut:["animate__animated","animate__fadeOut"]})}finally{r(!1)}},children:[jsx("label",{htmlFor:"font-2-l",children:"Nome Completo"}),jsx(Input,{name:"name",className:"font-2-m font-light",type:"text"}),jsx("label",{htmlFor:"font-2-l",children:"Email"}),jsx(Input,{name:"email",className:"font-2-m font-light",type:"email"}),jsx("label",{htmlFor:"font-2-l",children:"Senha"}),jsx(Input,{name:"password",className:"font-2-m font-light",type:"password"}),jsx("label",{htmlFor:"font-2-l",children:"Confirme sua Senha"}),jsx(Input,{name:"password_confirm",className:"font-2-m font-light",type:"password"}),a?jsx(Spinner,{}):jsx(Button,{className:"font-1-s",type:"submit",margin:"10px 0 0 0",children:"Enviar"})]}),jsx(Link,{to:"/signup"})]})})},Container=styled.main`
    max-width: 1200px;
    margin: 0 auto;
...
`;var PresentationError=()=>{const e=useAuthenticateApi();useParams();const a=useNavigate(),r=useLocation(),{problemId:d}=r.state,c=async()=>{try{const t=await e.post(`/doubt/problem/${d}`,{});dist.exports.Store.addNotification({title:"Enviado",message:"Solicita\xE7\xE3o para falar com orientador foi criada com sucesso \u{1F600}",type:"success",container:"top-center",dismiss:{duration:3e3}}),a("/chat",{state:{doubtId:t.data.id}})}catch(t){t.response&&dist.exports.Store.addNotification({title:"Erro",message:t.response.data.error.message,type:"danger",container:"top-center",dismiss:{duration:3e3}}),console.error(t)}};return jsxs(Fragment,{children:[jsx("h2",{style:{textAlign:"center"},className:"font-2-l font-light",children:"Que pena \u{1F61E}"}),jsx(StatusSVG$2,{className:"red font-2-m font-light",children:jsx("p",{children:"Seu c\xF3digo executou, mas voc\xEA apresentou as sa\xEDdas incorretamente"})}),jsxs("p",{style:{textAlign:"center"},children:["Voc\xEA pode solicitar ajuda com um orientador",jsx("a",{className:"blue",onClick:t=>c(),style:{cursor:"pointer"},children:" clicando aqui"})]}),jsx("p",{className:"font-2-s font-light gray-3",style:{textAlign:"center"},children:"*Dica: tente refaze-lo usando outras entradas al\xE9m das demonstra\xE7\xF5es apresentadas pelo exerc\xEDcio"}),jsx("p",{className:"font-2-s font-light gray-3",style:{textAlign:"center"},children:"*Dica: use e abuse da fun\xE7\xE3o \u201Ctestar\u201D antes de submeter seu c\xF3digo"})]})},icon="/assets/deadEmoticon.8febccb7.svg";const StatusSVG$1=styled.div`
    display: flex;
    align-items: center;
    flex-direction: column;
    justify-content: center;
...
`;var RuntimeError=({errorLog:e})=>{var o;const[a,r]=react.exports.useState(!1),d=useAuthenticateApi();useParams();const c=useLocation(),{problemId:t}=c.state,x=useNavigate(),u=async()=>{try{const l=await d.post(`/doubt/problem/${t}`,{});dist.exports.Store.addNotification({title:"Enviado",message:"Solicita\xE7\xE3o para falar com orientador foi criada com sucesso \u{1F600}",type:"success",container:"top-center",dismiss:{duration:3e3}}),x("/chat",{state:{doubtId:l.data.id}})}catch(l){l.response&&dist.exports.Store.addNotification({title:"Erro",message:l.response.data.error.message,type:"danger",container:"top-center",dismiss:{duration:3e3}}),console.error(l)}},n=()=>{r(!a)},m=react.exports.useMemo(()=>{try{let l=JSON.parse(e),g=new Error(l.message);return g.name=l.name,g}catch{return new Error("N\xE3o conseguimos avaliar o erro")}},[e]);return jsxs(Fragment,{children:[jsx("h2",{style:{textAlign:"center"},className:"font-2-l font-light",children:"Eita \u{1F633}"}),jsx(StatusSVG$1,{className:"red font-2-m font-light",children:jsx("p",{children:"O c\xF3digo submetido n\xE3o executou direito."})}),jsxs("p",{style:{textAlign:"center"},children:["Voc\xEA pode solicitar ajuda com um orientador",jsx("a",{className:"blue",onClick:l=>u(),style:{cursor:"pointer"},children:" clicando aqui"})]}),jsx("p",{className:"font-2-s font-light gray-3",style:{textAlign:"center"},children:"*Dica: verifique se os tipos que voc\xEA usou (texto, n\xFAmero, lista etc.) coicidem com as fun\xE7oes que voc\xEA usou"}),jsxs("p",{className:"font-2-s font-light gray-3",style:{textAlign:"center",marginBottom:20},children:['*Dica: verifique se a quantidade de vezes que voc\xEA usou o bloco "pedir um texto/numero" ',jsx("br",{}),"coicidem com a quantidade de entradas"]}),jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",width:"100%"},children:[jsx(Button,{onClick:l=>n(),margin:"10px 0",color:colors.textGray,backgroundColor:colors.primary_input_background,children:"Mostrar detalhes (avan\xE7ado)"}),jsx("div",{style:{padding:"10px 20px",backgroundColor:colors.primary_input_background,borderRadius:4,opacity:a?"1":"0",transition:"opacity ease-in .5s"},children:jsx("pre",{children:jsx("code",{style:{fontSize:"12px"},children:(o=`${m.message}
...
`;var WrongAnswer=({successfulRate:e})=>{var x,u;const a=useAuthenticateApi();useParams();const r=useNavigate(),c=(u=(x=useLocation().state)==null?void 0:x.problemId)!=null?u:"",t=async()=>{try{const n=await a.post(`/doubt/problem/${c}`,{});dist.exports.Store.addNotification({title:"Enviado",message:"Solicita\xE7\xE3o para falar com orientador foi criada com sucesso \u{1F600}",type:"success",container:"top-center",dismiss:{duration:3e3}}),r("/chat",{state:{doubtId:n.data.id}})}catch(n){n.response&&dist.exports.Store.addNotification({title:"Erro",message:n.response.data.error.message,type:"danger",container:"top-center",dismiss:{duration:3e3}}),console.error(n)}};return jsxs(Fragment,{children:[jsx("h2",{style:{textAlign:"center"},className:"font-2-l font-light",children:"Que pena \u{1F61E}"}),jsx(StatusSVG,{className:"red font-2-m font-light",children:jsx("p",{children:"Seu c\xF3digo executou, mas ele n\xE3o passou pelos testes do juiz"})}),jsxs("p",{style:{textAlign:"center"},children:["Mas vamos l\xE1, n\xE3o desista! Voc\xEA acertou ",jsx("strong",{children:jsxs("span",{className:"red",children:[e*100,"%"]})})," dos casos de teste!"]}),jsxs("p",{style:{textAlign:"center"},children:["Voc\xEA pode solicitar ajuda com um orientador",jsx("a",{className:"blue",onClick:n=>t(),style:{cursor:"pointer"},children:" clicando aqui"})]}),jsx("p",{className:"font-2-s font-light gray-3",style:{textAlign:"center"},children:"*Dica: tente refaze-lo usando outras entradas al\xE9m das demonstra\xE7\xF5es apresentadas pelo exerc\xEDcio"}),jsx("p",{className:"font-2-s font-light gray-3",style:{textAlign:"center"},children:"*Dica: use e abuse da fun\xE7\xE3o \u201Ctestar\u201D antes de submeter seu c\xF3digo"})]})};const Show=()=>{const e=useParams(),a=useAuthenticateApi(),r=useNavigate(),[d,c]=react.exports.useState(),[t,x]=react.exports.useState(!0);react.exports.useEffect(()=>((async()=>m())(),clearTimeout()),[]);const u=o=>new Promise((l,g)=>setTimeout(l,o));function n(o){switch(o==null?void 0:o.status){case SubmissionStatus.ACCEPTED:return jsx(Success,{});case SubmissionStatus.PRESENTATION_ERROR:return jsx(PresentationError,{});case SubmissionStatus.RUNTIME_ERROR:return jsx(RuntimeError,{errorLog:o.error});case SubmissionStatus.PENDING:return jsx(Waiting,{});case SubmissionStatus.WRONG_ANSWER:return jsx(WrongAnswer,{successfulRate:o.successfulRate});default:return jsx(Waiting,{})}}const m=async()=>{let o=!0;for(;o;)try{clearTimeout();const l=await a.get(`submissions/${e.id}?filter=${JSON.stringify({include:[{relation:"problem",scope:{fields:{id:!0,title:!0}}}]})}`);if(console.log(l.data),l.data.length==0)return dist.exports.Store.addNotification({container:"top-center",insert:"bottom",title:"Hum, algo deu errado",message:"N\xE3o encontramos a submiss\xE3o que voc\xEA procurou",type:"info",dismiss:{duration:3e3,onScreen:!0}}),r("/");if(l.data.status!=SubmissionStatus.PENDING){c(l.data),o=!1;break}await u(2e3)}catch(l){console.log(l),o=!1,clearTimeout()}finally{t&&x(!1)}};return t?jsx(Background,{children:jsx(Container$3,{children:jsx(Card,{className:"d-flex j-center ",padding:"10px 20px 40px 20px",children:jsx(Spinner,{width:"40px",height:"40px"})})})}):jsx(Background,{children:jsxs(Container$3,{children:[jsx("h1",{style:{textAlign:"center",marginBottom:"20px"},className:"font-1-xl white font-light",children:d&&d.problem.title}),jsx(Card,{padding:"10px 20px 40px 20px",children:n(d)})]})})},Form$3=styled.form`
    display: grid;
